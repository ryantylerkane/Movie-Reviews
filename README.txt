...
2. The program requires that the input directory contains "pos" and "neg" sub-folders, each containing their respective test/train documents.
...
3. Unicode encoding was required to be used for the input files due to the usage of some Unicode characters in the test/training reviews.
